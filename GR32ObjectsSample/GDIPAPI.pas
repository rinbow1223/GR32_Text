      ...
      {                                                                  }
      { 30-09-2009 Modified by Angus Johnson (angusj<at>myrealbox<.>com) }
      {            Added a compiler conditional statement so DirectDraw  }
...
{.$DEFINE SUPPORT_DIRECTDRAWSURFACES}
...
uses
  Windows,
  ActiveX,
  {$IFDEF SUPPORT_DIRECTDRAWSURFACES}
  DirectDraw,
  {$ENDIF}
  Math;
