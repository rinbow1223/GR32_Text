...
begin
  ...
  if PageControl1.ActivePage = TabSheet4 then
    lblRotation.Caption := format('%dº',[Constrain(sbRotation.Position, -45, 45)]) else
    lblRotation.Caption := format('%dº',[sbRotation.Position]);
...
//  Image.Bitmap.Canvas.TextOut(500,150, 'TextOut');
  ...
  try
    ...
    ////////////////////////////////////////////////////////////////////////////
    // Draw a line of text using different colors, fonts and sizes              
    ////////////////////////////////////////////////////////////////////////////
